...
# Test cases
print(list_to_array(mergeTwoLists(create_list([1,2,4]), create_list([1,3,4]))))  # Expected: [1,1,2,3,4,4]
print(list_to_array(mergeTwoLists(create_list([]), create_list([]))))  # Expected: []
print(list_to_array(mergeTwoLists(create_list([]), create_list([0]))))  # Expected: [0]`,
      java: `import java.util.*;
...
class Solution {
    ...
    public static void main(String[] args) {
        System.out.println(listToArray(mergeTwoLists(createList(new int[]{1,2,4}), createList(new int[]{1,3,4})))); // Expected: [1,1,2,3,4,4]
        System.out.println(listToArray(mergeTwoLists(createList(new int[]{}), createList(new int[]{})))); // Expected: []
        System.out.println(listToArray(mergeTwoLists(createList(new int[]{}), createList(new int[]{0})))); // Expected: [0]
    }
}`,
    },
    expectedOutput: {
...
print(maxProfit([7,6,4,3,1]))  # Expected: 0`,
  ...
  "invert-binary-tree": {
    ...
    description: {
      ...
      notes: ["Inverting a binary tree means swapping the left and right children of every node in the tree."],
    },
    examples: [
      {
        input: "root = [4,2,7,1,3,6,9]",
        output: "[4,7,2,9,6,3,1]",
        explanation: "The tree is inverted by swapping left and right children at each node.",
      },
      {
        input: "root = [2,1,3]",
        output: "[2,3,1]",
...
// Test cases
console.log(treeToArray(invertTree(createTree([4,2,7,1,3,6,9])))); // Expected: [4,7,2,9,6,3,1]
console.log(treeToArray(invertTree(createTree([2,1,3])))); // Expected: [2,3,1]
console.log(treeToArray(invertTree(createTree([])))); // Expected: []`,
...
# Test cases
print(tree_to_list(invertTree(create_tree([4,2,7,1,3,6,9]))))  # Expected: [4,7,2,9,6,3,1]
print(tree_to_list(invertTree(create_tree([2,1,3]))))  # Expected: [2,3,1]
print(tree_to_list(invertTree(create_tree([]))))  # Expected: []`,
      java: `import java.util.*;
...
class Solution {
    ...
    // Helper method to convert tree to list (level order)
    ...
    public static void main(String[] args) {
        System.out.println(treeToList(invertTree(createTree(new Integer[]{4,2,7,1,3,6,9}, 0)))); // Expected: [4,7,2,9,6,3,1]
        System.out.println(treeToList(invertTree(createTree(new Integer[]{2,1,3}, 0)))); // Expected: [2,3,1]
        System.out.println(treeToList(invertTree(createTree(new Integer[]{}, 0)))); // Expected: []
    }
}`,
    },
    expectedOutput: {
